...
<!-- TEAM -->
	<div class="diffSection" id="team_section">
		<center><p style="font-size: 50px; padding-top: 100px; padding-bottom: 60px;"></p>The Creator</p></center>
		<div class="totalcard">
			<div class="card">
				<center><img src="https://www.shutterstock.com/image-illustration/shyam-name-logo-stylish-cool-260nw-2102404033.jpg"></center>
				<center><div class="card-title">Shyam Varma</div>
				<div id="detail">
					...
					<div class="duty"></div>
					<a href="https://www.linkedin.com/in/b-shyam-varma-18254b250/" target="_blank"><button class="btn-roshan">Follow +</button></a>
				</div>
				</center>
			</div>
...
<!-- Sliding Information -->
	<marquee style="background: linear-gradient(to right, #FA4B37, #DF2771); margin-top: 50px;" direction="left" onmouseover="this.stop()" onmouseout="this.start()" scrollamount="20"><div class="marqu">"Limeted Seats available...Enroll now"</div></marquee>
	...
	<footer>
		<div class="footer-container">
			<div class="left-col">
				...
				<p class="rights-text">Copyright © 2023 Created By Shyam varma, Pr.Mallikarjuna All Rights Reserved.</p>
				<br><p><img src="images/icon/location.png"> Vellore Technology Of Institutes <br>Amaravathi, Andhra Pradesh-522237</p><br>
				<p><img src="images/icon/phone.png"> +917013699547<br><img src="images/icon/mail.png">&nbsp; learnedonline9419@gmail.com</p>
			</div>
			<div class="right-col">
